...
class ShowImage(QMainWindow):
    ...
    def contrastStretchingClicked(self):
        ...
        # Command Soal 5: Gunakan rmin/rmax aktual citra untuk Persamaan (6).
        ...
        print("\n=== ANALISIS CONTRAST STRETCHING (A6) ===")
        ...
        print(
            f"Sesudah  -> min:{int(np.min(stretched_img))}, "
            f"max:{int(np.max(stretched_img))}, "
            f"mean:{float(np.mean(stretched_img)):.2f}"
        )
    ...
    def saveClicked(self):
        if self.contrast_stretching_image is not None:
        ...
        if window == 1:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label brightness (imglabel3/imglabel_3) tidak ditemukan di A6.ui.",
                )
                return
        elif window == 4:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label contrast (imglabel4/imglabel_4) tidak ditemukan di A6.ui.",
                )
                return
        else:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label contrast stretching (imglabel5/imglabel_5) tidak ditemukan di A6.ui.",
                )
                return
