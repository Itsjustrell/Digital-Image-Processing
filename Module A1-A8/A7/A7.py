...
class ShowImage(QMainWindow):
    ...
    def contrastStretchingClicked(self):
        ...
        print("\n=== ANALISIS CONTRAST STRETCHING (A7) ===")
    ...
    def negativeClicked(self):
        ...
        print(
            f"Sesudah  -> min:{int(np.min(negative_img))}, "
            f"max:{int(np.max(negative_img))}, "
            f"mean:{float(np.mean(negative_img)):.2f}"
        )
    ...
    def saveClicked(self):
        if self.negative_image is not None:
        ...
        if window == 1:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label brightness (imglabel3/imglabel_3) tidak ditemukan di A7.ui.",
                )
                return
        elif window == 4:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label contrast (imglabel4/imglabel_4) tidak ditemukan di A7.ui.",
                )
                return
        elif window == 5:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label contrast stretching (imglabel5/imglabel_5) tidak ditemukan di A7.ui.",
                )
                return
        else:
            ...
            if target_label is None:
                QtWidgets.QMessageBox.warning(
                    self,
                    "UI Error",
                    "Label negative image (imglabel6/imglabel_6) tidak ditemukan di A7.ui.",
                )
                return
